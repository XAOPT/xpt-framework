...
## version: 0.1.1
####
## загружает контроллер компонента (имя компонента)
####
...
####
## загружает модель компонента (имя компонента, префикс)
## имя файла модели формеруется как: model/имякомпонента_префикс
####
...
####
## возвращает путь к папке шаблонов компонента.
####
...
####
## ищет все плагины для этого компонента и функции и возвращает массив их выходов
####
